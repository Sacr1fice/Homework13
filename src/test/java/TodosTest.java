...
public class TodosTest {
    ...
    public void shouldSearchWork() {
        ...
        Task[] actual3 = todos.search("Выкатка");
        Assertions.assertArrayEquals(expected3, actual3);

    }

    @Test
    public void shouldSearchWorkWithNoMatches() {
        SimpleTask simpleTask = new SimpleTask(5, "Позвонить родителям");
    ...
    @Test
    public void shouldSearchWorkWithMultipleMatches() {
        SimpleTask simpleTask = new SimpleTask(5, "Позвонить родителям");
    ...
    @Test
    public void shouldSearchWorkWithMultipleMatchesInMeeting() {
        SimpleTask simpleTask = new SimpleTask(5, "Позвонить родителям");
